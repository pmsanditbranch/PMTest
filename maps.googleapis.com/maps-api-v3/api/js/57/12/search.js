google.maps.__gjsload__("search", function (_) {
    ...
    vsa = class {
      ...
      getAnchor() {
        if (!this.anchor) {
          ...
          this.anchor = _.Rm(
            new _.cn(
              (this.vp.x * 256 + this.source.a[0]) / a,
              (this.vp.y * 256 + this.source.a[1]) / a
            )
          ).toJSON();
        }
        return this.anchor;
      ...
      if (!zsa.has(a)) {
        ...
        var c = [],
          ...
          e = () => {
            ...
            b.forEach((f) => {
              if ((f = f.data))
                c.push(_.Ak(f, "insert", (g) => d(g, "addfeatures"))),
                  c.push(_.Ak(f, "remove", (g) => d(g, "removefeatures")));
            });
          };
  ...
  _.Ea(
    "module$contents$mapsapi$onionLayers$search$googleLayer_GoogleLayer.enableFeatureMapEventsRasterOnly",
    hD.enableFeatureMapEventsRasterOnly
  );
  _.yl(hD.prototype, { map: _.Up });
  _.qa.google.maps.search = { GoogleLayer: hD };
  _.sk("search", {});
});
