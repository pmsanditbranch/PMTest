google.maps.__gjsload__("search_impl", function (_) {
  var Otb = function (a, b) {
      _.G(a.Hg, 3, b);
    },
    Stb = function (a, b, c) {
      const d = _.NK(new Ptb());
      c.Vq = (0, _.Ca)(d.load, d);
      c.clickable = a.get("clickable") != 0;
      _.kWa(c, _.DR(b));
      const e = [];
      e.push(_.Ak(c, "click", (0, _.Ca)(Qtb, null, a)));
      _.Kb(["mouseover", "mouseout", "mousemove"], function (f) {
        e.push(_.Ak(c, f, (0, _.Ca)(Rtb, null, a, f)));
      });
      e.push(
    ...
    Qtb = function (a, b, c, d, e) {
      ...
      if (e && ((f = { status: e.getStatus() }), e.getStatus() == 0)) {
        f.location = _.U(e.Hg, 2)
          ? new _.Vj(
              _.vu(_.K(e.Hg, 2, _.Au).Hg, 1),
              _.vu(_.K(e.Hg, 2, _.Au).Hg, 2)
            )
          : null;
        f.fields = {};
        const g = _.Ii(e.Hg, 3);
    ...
    Rtb = function (a, b, c, d, e, f, g) {
      let h = null;
      f && (h = { title: f[1].title, snippet: f[1].snippet });
      _.Ok(a, b, c, d, e, h, g);
    },
    Ttb = function () {},
    Utb = class extends _.R {
      constructor() {
        super();
      }
      Pi() {
  ...
  var Ptb = class {
    constructor() {
      ...
      this.Eg = _.dr(
        _.ty,
        a,
        _.OA + "/maps/api/js/LayersService.GetFeature",
        b
      );
    }
    load(a, b) {
  ...
  Ttb.prototype.VE = function (a) {
    if (_.In[15]) {
      ...
      b &&
        a.Eg &&
        (a.Gg
          ? ((b = b.__gm.Vj), b.set(b.get().Cn(a.Eg)))
          : a.Eg && _.HWa(a.Eg, b) && (_.Kb(a.Fg || [], _.Ck), (a.Fg = null)));
      if (c) {
        b = new _.Cx();
        ...
        a.get("spotlightDescription") &&
          (b.spotlightDescription = new _.Vx(a.get("spotlightDescription")));
        a.get("paintExperimentIds") &&
          (b.paintExperimentIds = a.get("paintExperimentIds").slice(0));
        a.get("styler") && (b.styler = new _.Nx(a.get("styler")));
        a.get("roadmapStyler") &&
          (b.roadmapStyler = new _.Nx(a.get("roadmapStyler")));
        a.get("travelMapRequest") &&
          (b.travelMapRequest = new _.dpa(a.get("travelMapRequest")));
        a.get("mapsApiLayer") &&
          (b.mapsApiLayer = new _.Ix(a.get("mapsApiLayer")));
        ...
        a.get("searchPipeMetadata") &&
          (b.searchPipeMetadata = new _.jA(a.get("searchPipeMetadata")));
        a.get("gmmContextPipeMetadata") &&
          (b.gmmContextPipeMetadata = new _.Ama(
            a.get("gmmContextPipeMetadata")
          ));
        a.get("overlayLayer") &&
          (b.overlayLayer = new _.Wx(a.get("overlayLayer")));
        ...
        a.get("airQualityPipeMetadata") &&
          (b.airQualityPipeMetadata = new _.Ioa(
            a.get("airQualityPipeMetadata")
          ));
        a.get("directionsPipeParameters") &&
          (b.directionsPipeParameters = new _.lB(
            a.get("directionsPipeParameters")
          ));
        a.get("clientSignalPipeMetadata") &&
          (b.clientSignalPipeMetadata = new _.Xla(
            a.get("clientSignalPipeMetadata")
          ));
        b.darkLaunch = !!a.get("darkLaunch");
        a.Eg = b;
        a.Gg = a.get("renderOnBaseMap");
        a.Gg ? ((a = c.__gm.Vj), a.set(a.get().El(b))) : Stb(a, c, b);
        _.Ll(c, "Lg");
        _.Jl(c, 148282);
      }
    }
  };
  _.sk("search_impl", new Ttb());
});
