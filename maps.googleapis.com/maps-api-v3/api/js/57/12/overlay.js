google.maps.__gjsload__("overlay", function (_) {
  var RD = function (a) {
    ...
    Sva = function (a, b) {
      ...
      e = () => _.rn(d.Ch);
      c.Qh = [
        _.Ak(a, "panes_changed", e),
        _.Ak(f, "zoom_changed", e),
        _.Ak(f, "offset_changed", e),
        _.Ak(b, "projection_changed", e),
        _.Ak(f, "projectioncenterq_changed", e),
      ];
      _.rn(d.Ch);
      b instanceof _.al
        ? (_.Ll(b, "Ox"), _.Jl(b, 148440))
        : b instanceof _.mm && (_.Ll(b, "Oxs"), _.Jl(b, 181451));
    },
    Xva = function (a) {
      if (a) {
        var b = a.getMap();
        if (Tva(a) !== b && b && b instanceof _.al) {
          const c = b.__gm;
          c.overlayLayer
            ? (a.__gmop = new Uva(b, a, c.overlayLayer))
            : c.Fg.then(({ lh: d }) => {
                const e = new Vva(b, d);
                d.Bi(e);
                c.overlayLayer = e;
  ...
  RD.prototype.changed = function (a) {
    a != "outProjection" &&
      ...
      a == !this.get("outProjection") &&
        this.set("outProjection", a ? this.Eg : null));
  };
  var TD = {};
  _.Ga(Rva, _.Vk);
  TD.Dl = function (a) {
  ...
  _.sk("overlay", {
    ...
    preventMapHitsAndGesturesFrom: (a) => {
      ...
      a.addEventListener("MSPointerDown", _.yk);
