google.maps.__gjsload__("onion", function (_) {
  ...
  ZVa = function (a) {
    return a.Zi
      ? _.MG("background-color", _.OG(a.component, "", -2, -3))
      : _.OG(a.component, "", -2, -3);
  };
  $Va = function (a) {
    ...
    return [
      ...
      [
        ...
        [
          ...
          function (a) {
            return a.Zi
              ? _.MG("display", _.OG(a.Pm, !1, -2) ? "none" : "")
              : _.OG(a.Pm, !1, -2)
              ? "none"
              : "";
          },
      ...
      [
        ...
        function (a) {
          return (a.Ny =
            _.OG(a.vn, 0, -5) == 0 ? 15 : _.OG(a.vn, 0, -5) == 1 ? 12 : 6);
        },
        "var",
        function (a) {
  ...
  dWa = function () {
    return [
      ...
      [
        ...
        "var",
        function (a) {
          return (a.LM = _.OG(a.component, 0, -1) == 5);
        },
        "var",
        function (a) {
      ...
      [
        ...
        "$a",
        [7, , , $Va, , "renderable-component-bold"],
        "$a",
        [
          7,
          ,
        ...
        [
          ...
          function (a) {
            return a.Zi
              ? _.MG("color", _.OG(a.component, "", -2, -4))
              : _.OG(a.component, "", -2, -4);
          },
          "color",
          ,
          ,
  ...
  fWa = function (a, b) {
    ...
    for (let d = 0; d < b; ++d)
      (qR[d] = eWa[(a.x & c ? 2 : 0) + (a.y & c ? 1 : 0)]), (c >>= 1);
    return qR.join("");
  };
  gWa = function (a) {
    return a.charAt(1);
    ...
    if (!d[e] && !b.freeze) {
      ...
      var h = g ? a.Kg : a.Jg,
        k = h.load(f, function (m) {
          ...
          let p = b.layerId;
          p = jWa(p);
          if ((m = m && m[c.Eg] && m[c.Eg][p]))
            (m.mw = b),
              m.tiles || (m.tiles = new _.yn()),
              _.zn(m.tiles, c),
              _.zn(b.data, m),
              _.zn(c.data, m);
          m = { coord: c.ci, zoom: c.zoom, hasData: !!m };
          a.Gg && a.Gg(m, b);
        });
      k &&
        (d[e] = function () {
  ...
  xWa = function (a, b) {
    return function (c, d) {
      ...
      b
        ? ((c = (0, _.Fo)(new _.yt(f).setQuery(c, !0).toString())),
          _.fGa(c, { mi: e, Hm: e, PA: !0 }))
  ...
  GWa = function (a, b, c, d) {
    ...
    f.Fg.then(function (w) {
      ...
      _.qs(w.Jq, function (z) {
        z && m != z.ei && ((m = z.ei), (p = e()), t.set(p.Fk()));
      });
    });
  };
  _.DR = function (a) {
    ...
    _.Ak(a, "click", function (e) {
      d = window.setTimeout(function () {
        ...
        if (f) {
          ...
          h
            ? h(
                new _.tR(f.layerId, e.feature.id, f.parameters),
                _.Ca(_.Ok, _.Tp, f, "click", e.feature.id, g, e.anchorOffset)
              )
            : ((h = null),
  ...
  IWa = function () {
    return [
      ...
      [
        ...
        "$up",
        ["t-t0weeym2tCw", { entity: JWa, Pm: KWa }],
      ],
      [
        "for",
        [
      ...
      [
        ...
        "$up",
        ["t-DjbQQShy8a0", { entity: JWa, Pm: KWa }],
      ],
      [
        "$a",
        [
  ...
  MWa = function (a, b) {
    b.substr(0, 2) == "0x"
      ? (_.G(a.Hg, 1, b), _.fh(a.Hg, 4))
      : (_.G(a.Hg, 4, b), _.fh(a.Hg, 1));
  };
  OWa = function (a) {
    let b = null;
    _.Ak(a.Ig, "click", (c, d) => {
    ...
    ["ddsfeaturelayersclick", "ddsfeaturelayersmousemove"].forEach((b) => {
      _.Ak(a.Ig, b, (c, d, e) => {
        ...
        for (const h of e) {
          ...
          (g = _.gn(g, { featureType: e.featureType, datasetId: m }).isAvailable
        ...
        if (f.size > 0 && d.latLng && d.domEvent)
          for (const [h, k] of f) _.Ok(h, c, new RWa(d.latLng, d.domEvent, k));
      });
    });
  };
  TWa = function (a) {
  ...
  UWa = function (a) {
    a.Fg ||
      (_.qGa(a.Eg.getDiv()),
      (a.Fg = new _.Zp({ lu: !0, logAsInternal: !0 })),
    ...
    if (d && d.Uq) {
      ...
      if (e)
        if (GR(a.Eg)) QWa(a, "smnoplaceclick", d.Uq, d.ii, e);
          ...
          a.Og(e, _.cj.Eg(), (h) => {
            f
              ? _.Jl(a.Eg, _.aj(h.Hg, 28) === f ? 226501 : 226502)
              : ((f = _.aj(h.Hg, 28)), (g = WWa(a, c, d, f)));
            (g && g.domEvent && _.ns(g.domEvent)) ||
              ((a.Kg = b.anchorOffset || _.rm), (a.Gg = h), XWa(a));
          });
        }
    }
  };
  ...
  WWa = function (a, b, c, d) {
    ...
    a.Jg &&
      b.domEvent &&
      ((f = new YWa(a.Jg, b.domEvent, d)), _.Ok(a.Eg, "click", f));
    return f;
  };
  XWa = function (a) {
    if (a.Gg) {
      var b = "",
        c = a.Eg.get("mapUrl");
      c &&
        ((b = c), (c = _.aj(_.K(a.Gg.Hg, 1, IR).Hg, 4)) && (b += "&cid=" + c));
      c = new ZWa();
      _.G(c.Hg, 1, b);
      _.G(c.Hg, 2, !0);
      ...
      a.Lg.update([a.Gg, c], () => {
        const e = _.U(a.Gg.Hg, 19)
          ? _.K(a.Gg.Hg, 19, $Wa).oj()
          : a.Gg.getTitle();
        a.Fg.setOptions({ ariaLabel: e });
        a.Fg.setPosition(d);
        a.Kg && a.Fg.setOptions({ pixelOffset: a.Kg });
        a.Fg.get("map") || (a.Fg.setContent(a.Lg.wh), a.Fg.open(a.Eg));
      });
      a.Mg.update([a.Gg, c], () => {
        a.Fg.setHeaderContent(a.Mg.wh);
      });
      _.U(a.Gg.Hg, 19) || a.Fg.setOptions({ minWidth: 228 });
    }
  };
  GR = function (a) {
  ...
  gXa = function (a, b, c) {
    ...
    _.ty(
      _.Go,
      _.BB + "/maps/api/js/jsonp/ApplicationService.GetEntityDetails",
      _.Fo,
      a,
      function (f) {
        f = new eXa(f);
  ...
  iXa = function (a) {
    for (var b = "" + a.getType(), c = 0, d = _.Ii(a.Hg, 2); c < d; ++c)
      b +=
        "|" +
        _.gs(a.Hg, 2, _.Gx, c).getKey() +
        ":" +
        _.gs(a.Hg, 2, _.Gx, c).getValue();
  ...
  lXa = function (a, b, c) {
    ...
    sWa(this.Eg, "smartmaps", c, e, h, null, function (B, C) {
      ...
      if (C == B) for (; c.getLength() > 1; ) c.removeAt(0);
    });
    var y = new yWa(c, !1);
    ...
    a.__gm.Fg.then(function (B) {
      ...
      _.qs(B.Jq, function (H) {
        H &&
          !H.ei.equals(p) &&
          ((p = H.ei), (t = new _.hB(f, p)), v.set(t), d());
      });
    });
    _.CL(a, v, "mapPane", 0);
  };
  kXa = function (a, b) {
    ...
    if (d.c) {
      ...
      e =
        (y[31581606] && y[31581606].entity && y[31581606].entity.query) ||
        (y[1] && y[1].title) ||
        "";
      var z = document;
      ...
      h =
        y[31581606] &&
        y[31581606].entity &&
        y[31581606].entity.feature_id_format;
      g = y[31581606] && y[31581606].entity;
      m = y[43538507];
      k = y[1] && y[1].hotel_data;
      v = (y[1] && y[1].is_transit_station) || !1;
  ...
  var aXa = class extends _.R {
    ...
    dXa = [
      ...
      ,
      ,
      [_.L, , MR, _.O, _.Q, _.P, , MR, _.O, _.L, MR, _.JA],
      1,
      _.Q,
      1,
      ,
  ...
  yR.prototype.handleEvent = function (a, b) {
    ...
    if (
      ...
      if (((c = this.Ig), a == "mouseover" || a == "mousemove"))
        this.Jg.set("cursor", "pointer"), (this.Eg = c);
    } else if (a == "mouseout")
      (c = this.Eg), this.Jg.set("cursor", ""), (this.Eg = null);
    else return;
  ...
  AR.prototype.load = function (a, b) {
    ...
    _.Kb(a.tiles || [], function (g) {
      (g = d({ oh: g.ci.x, ph: g.ci.y, vh: g.zoom })) && _.xka(c, g);
    });
    e.XJ &&
      _.Kb(a.yh || [], function (g) {
  ...
  var xXa = [0, () => QR, _.jz],
    QR = [
      ...
      PR,
      _.mz,
      [0, [2, 3, 4], PR, _.gz, mXa, _.mz, _.Xz, PR],
      _.mz,
      () => xXa,
      _.mz,
      [0, PR, -1, _.Zo, PR, _.Xz],
  ...
  var jXa = class {
    constructor(a, b, c) {
      ...
      this.Ng = c;
      this.Og = gXa;
      this.Lg = new _.VL(FR, { mq: _.zB.vj() });
      this.Mg = new _.VL(oR, { mq: _.zB.vj() });
  ...
  lXa.prototype.Kg = function () {
    ...
    if (e && this.Eg.getClickableIcons() != 0) {
      ...
      if ((f = this.Gg.Zx(f ? Math.round(f) : f))) {
        ...
        d = c.get("apistyle") || "";
        e = c.get("style") || [];
        a.parameters.salt = (0, _.Go)(
          d + "+" + _.oj(e, iXa).join(",") + c.get("authUser")
        );
      ...
      b.clear(),
        ...
        this.Eg.getClickableIcons() == 0 &&
          (_.Ll(this.Eg, "smd"), _.Jl(this.Eg, 148283));
  };
