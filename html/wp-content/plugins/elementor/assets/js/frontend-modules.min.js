...
!(function (t) {
    ...
    t.exports = function (t, e, n, d, v, h, y) {
      ...
      if (
        (L &&
          ...
          x.next &&
          (f(x, S, !0), r || "function" == typeof x[l] || u(x, l, g)),
        O &&
          P &&
          "values" !== P.name &&
          ((w = !0),
        ...
        [
          ...
          function (t, e) {
            ...
            for (var x = 0, b = 0, S = []; b < p.length; ) {
              ...
              if (
                null === w ||
                (O = l(c(m.lastIndex + (g ? 0 : b)), p.length)) === x
              )
                b = u(p, b, h);
              else {
  ...
  function (t, e, n) {
    ...
    var r = n(10),
      ...
      J = function defineProperty(t, e, n) {
        return (
          ...
          o(q, e)
            ? (n.enumerable
                ? (o(t, F) && t[F][e] && (t[F][e] = !1),
                  (n = w(n, { enumerable: O(0, !1) })))
                : (o(t, F) || D(t, F, O(1, {})), (t[F][e] = !0)),
              U(t, e, n))
            : D(t, e, n)
        );
      },
      ...
      Z = function getOwnPropertyNames(t) {
        for (var e, n = C(b(t)), r = [], i = 0; n.length > i; )
          o(q, (e = n[i++])) || e == F || e == s || r.push(e);
        return r;
      },
      tt = function getOwnPropertySymbols(t) {
        for (
          var e, n = t === H, r = C(n ? G : b(t)), i = [], u = 0;
          r.length > u;
    ...
    V ||
      ...
      (n(41).f = Y),
      (j.f = tt),
      i && !n(34) && c(H, "propertyIsEnumerable", Y, !0),
      (d.f = function (t) {
        return B(g(t));
      })),
    ...
    u(u.S + u.F * it, "Object", {
      ...
      I.prototype[R] || n(23)(I.prototype, R, I.prototype.valueOf),
      l(I, "Symbol"),
      l(Math, "Math", !0),
      l(r.JSON, "JSON", !0);
  },
