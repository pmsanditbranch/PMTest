(function ($) {
  ...
  $(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ovapo_project_slide.default",
      function () {
    ...
    /* Project Grid */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ovapo_project_grid.default",
      function () {
        $(".ovapo_project_grid .button-filter button:first-child").addClass(
          "active"
        );
