(function ($) {
  ...
  $(function () {
    var text = $(
      ".single_project .content .categories .info_detail, .single_project_middle .content .categories .info_detail"
    )
      .text()
      .trim();
  ...
  $(function () {
    ...
    var prevArrowTablet = $(
      ".single_project_middle .gallery .prev-arrow-tablet"
    );
    var nextArrowTablet = $(
      ".single_project_middle .gallery .next-arrow-tablet"
    );
  ...
  $(function () {
    var button = $(
      ".archive_project_default .filter-button-group, .archive_project_compact .filter-button-group, .archive_project_full .filter-button-group"
    );
