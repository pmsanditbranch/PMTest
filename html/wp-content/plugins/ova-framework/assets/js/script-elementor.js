  ...
  $(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function () {
        ...
        if (
          $(".ovamenu_shrink_mobile").length > 0 &&
          $("body").data("elementor-device-mode") != "desktop"
        ) {
          if (
            !$(".show_mask_header_mobile").hasClass("mask_header_shrink_mobile")
          ) {
            $(
              '<div class="show_mask_header_mobile mask_header_shrink_mobile" style="position: relative; height: 0;"></div>'
            ).insertAfter(".ovamenu_shrink_mobile");
          }
          ...
          $(window).scroll(function () {
            ...
            if (scroll >= header_shrink_height + 150) {
              header.addClass("active_fixed");
              $(".mask_header_shrink_mobile").css(
                "height",
                header_shrink_height
              );
            } else {
              header.removeClass("active_fixed");
    ...
    /* Search Popup */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_search_popup.default",
      function () {
    ...
    /* Slide Testimonial */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_blog_slider.default",
      function () {
    ...
    /* Skill bar */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_skill_bar.default",
      function () {
        $(".skillbar").appear();
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_about_team.default",
      function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_video_popup.default",
      function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_position.default",
      function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_teamwork.default",
      function () {
        $(document).ready(function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_process.default",
      function () {
        $(".ova-process .category ul li:first-child a").addClass("active");
        var data_class_first = $(
          ".ova-process .category ul li:first-child a"
        ).attr("data-class");
        $(".ova-process .content .item." + data_class_first).css(
          "display",
          "flex"
        );
        $(".ova-process .category ul li a")
          ...
          .on("click", function () {
            ...
            $(".ova-process .content .item." + data_class_active)
              .fadeIn(800)
              .addClass("active")
              .css("display", "flex");
            $(".ova-process .content .item.active:first i").css(
              "display",
              "none"
            );
            $(".ova-process .content .item.active:last").css(
              "margin-right",
              "0"
            );
            $(".ova-process .content .item.active:first .number").css(
              "border-bottom",
              "1px solid #999999"
            );
          });
    ...
    /* Services Slide */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_services_slide.default",
      function () {
    ...
    /* Ova Slideshow */
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_slideshow.default",
      function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ova_slide_item_landing.default",
      function () {
